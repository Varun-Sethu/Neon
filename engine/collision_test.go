...
func TestManifoldGeneration(t *testing.T) {
	polyA := entities.NewPolygon([]neonMath.Vector2D{{X: 0, Y: 100}, {X: 100, Y: 100}, {X: 100, Y: 0}, {X: 0, Y: 0}})
	polyB := entities.NewPolygon([]neonMath.Vector2D{{X: 50, Y: 101}, {X: 120, Y: 120}, {X: 150, Y: 70}, {X: 110, Y: 50}})
